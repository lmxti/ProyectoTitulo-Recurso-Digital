            ...
            if (functionsToCheck) {
                checkFunctions(userCode.replace(waitFunctionRegex, '//Esperar();'), functionsToCheck, (functionsResult) => {
                    ...
                    */
                    ...
                    exec(`javac -cp ./lib/* -d . src/com/heart/app/*.java && jar cfm executer${user}.jar MANIFEST.MF com/heart/app/*.class && java -jar executer${user}.jar`, options, (error, stdout, stderr) => {
                        if (error) {
