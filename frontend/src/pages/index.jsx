        ...
        <section className="flex flex-wrap items-center  font-sans px-4 mx-auto w-full lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md pb-20">
          ...
          <div className="px-3 w-full lg:w-2/5">
              ...
              <div className="text-center lg:text-left">
                  <a
                      className="block visible py-4 px-8 mb-4 text-xs font-semibold tracking-wide leading-none text-white bg-orange-500 transition duration-700 ease-in-out hover:bg-amber-700 hover:text-black rounded cursor-pointer sm:mr-3 sm:mb-0 sm:inline-block"
                      >Comenzar</a
                  >
