        ...
        <header className="bg-[#3A3F43]">
            <nav className="flex justify-between items-center w-[92%] mx-auto p-2">
                ...
                <ul className="flex md:flex-row flex-col md:items-center md:gap-[4vw] gap-8">
                    ...
                    <li>
                        <a className="text-white" href="/lessonsStages">Etapas</a>
                    </li>
                    <li>
                        <a className="text-white" href="/poo">¿Qué es la POO?</a>
                    </li>
                </ul>
            </div>
                <div>
                    <a href="/Etapa/1/0">
                        <button href="/Etapa/1/0" className="bg-teal-500 hover:bg-emerald-500 rounded-full text-white px-5 py-2">
                            Comenzar
                        </button>
                    </a>
                </div>
