            ...
            {(leccionInfo &&
                ...
                <div className="grid grid-cols-2 grid-rows-6 gap-5 m-4 h-screen">
                    ...
                    <div className="relative overflow-hidden h-min max-h-[calc(100%-48px-1.5rem)] mb-[1.5rem]">
                        ...
                        <div className={`bg-white text-warmGray-900 transition-all duration-500 overflow-y-scroll ${expand ? "h-0" : "h-screen"}`}>
                    ...
                    <div className="relative overflow-hidden h-min max-h-[calc(100%-48px-1.5rem)]">
                        ...
                        <div className={`bg-white text-warmGray-900 transition-all duration-500 overflow-y-scroll ${expand ? "h-screen" : "h-0"}`}>
