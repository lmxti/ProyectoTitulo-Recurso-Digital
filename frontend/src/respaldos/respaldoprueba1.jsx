                ...
                <div className="grid grid-cols-2 grid-rows-6 gap-5 m-4 h-screen">
                    ...
                    <section className="row-span-6">
                        ...
                        <div className="relative overflow-hidden h-min max-h-[calc(100%-48px-1.5rem)] mb-[1.5rem]">
                            ...
                            <div className="bg-blue-500 h-12 pl-5 flex items-center cursor-pointer">
                                <h1 className="text-lg font-semibold text-white">Contenido</h1>
                            </div>
                            ...
                            <div className={`overflow-y-scroll bg-white transition-all duration-500 h-0 peer-checked:h-[calc(100%-48px-2rem)]`}>
                                    <div> {leccionInfo.enunciado} </div>
                            </div>
                        </div>
                        ...
                        <div className="relative overflow-hidden h-min max-h-[calc(100%-48px-1.5rem)]">
                            <input type="checkbox" className="peer absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer"/>
                            <div className="bg-blue-500 h-12 pl-5 flex items-center cursor-pointer">
                                <h1 className="text-lg font-semibold text-white">Instrucciones</h1>
                            </div>

                            <div className={`overflow-y-scroll bg-white transition-all duration-500 h-0 peer-checked:h-screen`}>
                                    <div> {leccionInfo.instrucciones} </div>
                            </div>
                        </div>
                    </section>
